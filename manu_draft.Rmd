...
Conventional modes of delivering scientific products and more contemporary approaches that align with open science principles share the same goals within the research community.  Both approaches are motivated by the same guiding principles of the scientific method that
