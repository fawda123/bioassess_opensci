...
* The SCAPE tool ([https://sccwrp.shinyapps.io/SCAPE](https://sccwrp.shinyapps.io/SCAPE)) was created entirely using open-source software [i.e., R, @RDCT18; shiny, @Chang18]. This allowed use of additional packages described above, in addition to specific packages developed to support bioassessment in California (e.g., CSCI).
...
dev.off()
```
```{r scapexfig, fig.cap = 'SCAPE example'}
